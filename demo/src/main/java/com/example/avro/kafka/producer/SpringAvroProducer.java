package com.example.avro.kafka.producer;
...
public class SpringAvroProducer {
    ...
    public void send(StockHistory stockHistory){
        ListenableFuture<SendResult<String,StockHistory>> future= (ListenableFuture<SendResult<String, StockHistory>>) kafkaTemplate.send(topicName,String.valueOf(stockHistory.getTradeId()),stockHistory);
